...
export class DialogServiceStatusComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.service_id.setValue(data.id)
    this.service_business.setValue(data.business)
    this.service_description.setValue(data.description)
    // this.service_collectingEntity.setValue(this.data.resp.collectingEntity)
    this.service_serviceType.setValue(data.serviceType.name);
