...
export class NewServiceComponent implements OnInit {
    ...
    private async getIdService(idService: string): Promise<void> {
        try {
            ...
            if (data.fixedcomission && (data.typeComission == 'FIJO' || data.typeComission == 'MULTIPLE')) this.comission_fixed.setValue(data.fixedcomission);
            if (data.pctcomission && (data.typeComission == 'PORCENTUAL' || data.typeComission == 'MULTIPLE')) this.pctcomission.setValue(data.pctcomission);
            if (data.comissioncriterion && data.typeComission == 'MULTIPLE') this.comissioncriterion.setValue(data.comissioncriterion);
